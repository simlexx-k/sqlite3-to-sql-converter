CREATE TABLE "django_migrations" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "app" varchar(255) NOT NULL, "name" varchar(255) NOT NULL, "applied" datetime NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE "auth_group_permissions" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "group_id" integer NOT NULL REFERENCES "auth_group" ("id") DEFERRABLE INITIALLY DEFERRED, "permission_id" integer NOT NULL REFERENCES "auth_permission" ("id") DEFERRABLE INITIALLY DEFERRED) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


CREATE TABLE "auth_user_groups" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "user_id" integer NOT NULL REFERENCES "auth_user" ("id") DEFERRABLE INITIALLY DEFERRED, "group_id" integer NOT NULL REFERENCES "auth_group" ("id") DEFERRABLE INITIALLY DEFERRED) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE "django_admin_log" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "object_id" text NULL, "object_repr" varchar(200) NOT NULL, "action_flag" smallint unsigned NOT NULL CHECK ("action_flag" >= 0), "change_message" text NOT NULL, "content_type_id" integer NULL REFERENCES "django_content_type" ("id") DEFERRABLE INITIALLY DEFERRED, "user_id" integer NOT NULL REFERENCES "auth_user" ("id") DEFERRABLE INITIALLY DEFERRED, "action_time" datetime NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE "django_content_type" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "app_label" varchar(100) NOT NULL, "model" varchar(100) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE "auth_permission" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "content_type_id" integer NOT NULL REFERENCES "django_content_type" ("id") DEFERRABLE INITIALLY DEFERRED, "codename" varchar(100) NOT NULL, "name" varchar(255) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE "auth_group" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "name" varchar(150) NOT NULL UNIQUE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE "exams_learnertotalscore" ("learner_id" bigint NOT NULL PRIMARY KEY REFERENCES "learners_learnerregister" ("id") DEFERRABLE INITIALLY DEFERRED, "total_score" real NOT NULL, "exam_type_id" integer NULL REFERENCES "exams_examtype" ("exam_id") DEFERRABLE INITIALLY DEFERRED) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE "learners_feesmodel" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "register_date" datetime NOT NULL, "amount" integer NOT NULL, "payment_type" varchar(100) NOT NULL, "received_by" varchar(100) NOT NULL, "learner_id_id" bigint NOT NULL REFERENCES "learners_learnerregister" ("id") DEFERRABLE INITIALLY DEFERRED, "payment_method" varchar(20) NOT NULL, "payment_id" integer NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


CREATE TABLE "exams_subject" ("name" varchar(100) NOT NULL, "subject_id" integer NOT NULL PRIMARY KEY AUTOINCREMENT) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE "learners_school" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "name" varchar(100) NOT NULL, "principal_remark" text NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


CREATE TABLE "learners_grade" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "grade_name" varchar(100) NOT NULL UNIQUE, "grade_description" text NOT NULL, "class_teacher_remark" text NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE "exams_examtype" ("name" varchar(100) NOT NULL, "date_administered" date NOT NULL, "exam_id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "term" varchar(100) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

INSERT INTO exams_examtype (name, date_administered, exam_id, term) VALUES ('MID TERM 3', '2024-09-24', 4, 'Term 3');

CREATE TABLE authenticator_custompermission (id integer NOT NULL PRIMARY KEY AUTOINCREMENT, name varchar (255) NOT NULL UNIQUE, codename varchar (100) NOT NULL UNIQUE, content_type_id integer NOT NULL REFERENCES django_content_type (id) DEFERRABLE INITIALLY DEFERRED) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


CREATE TABLE authenticator_role (id integer NOT NULL PRIMARY KEY AUTOINCREMENT, name varchar (100) NOT NULL UNIQUE, description text NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


CREATE TABLE authenticator_customuser (id integer NOT NULL PRIMARY KEY AUTOINCREMENT, password varchar (128) NOT NULL, last_login datetime, is_superuser bool NOT NULL, username varchar (150) NOT NULL UNIQUE, first_name varchar (150) NOT NULL, last_name varchar (150) NOT NULL, email varchar (254) NOT NULL, is_staff bool NOT NULL, is_active bool NOT NULL, date_joined datetime NOT NULL, user_type varchar (20) NOT NULL, role_id bigint REFERENCES authenticator_role (id) DEFERRABLE INITIALLY DEFERRED) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE authenticator_rolepermission (id integer NOT NULL PRIMARY KEY AUTOINCREMENT, permission_id bigint NOT NULL REFERENCES authenticator_custompermission (id) DEFERRABLE INITIALLY DEFERRED, role_id bigint NOT NULL REFERENCES authenticator_role (id) DEFERRABLE INITIALLY DEFERRED) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


CREATE TABLE authenticator_userprofile (id integer NOT NULL PRIMARY KEY AUTOINCREMENT, bio text NOT NULL, date_of_birth date, profile_picture varchar (100), user_id bigint NOT NULL UNIQUE REFERENCES authenticator_customuser (id) DEFERRABLE INITIALLY DEFERRED) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


CREATE TABLE authenticator_customuser_groups (id integer NOT NULL PRIMARY KEY AUTOINCREMENT, customuser_id bigint NOT NULL REFERENCES authenticator_customuser (id) DEFERRABLE INITIALLY DEFERRED, group_id integer NOT NULL REFERENCES auth_group (id) DEFERRABLE INITIALLY DEFERRED) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


CREATE TABLE authenticator_customuser_custom_permissions (id integer NOT NULL PRIMARY KEY AUTOINCREMENT, customuser_id bigint NOT NULL REFERENCES authenticator_customuser (id) DEFERRABLE INITIALLY DEFERRED, custompermission_id bigint NOT NULL REFERENCES authenticator_custompermission (id) DEFERRABLE INITIALLY DEFERRED) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


CREATE TABLE authenticator_customuser_user_permissions (id integer NOT NULL PRIMARY KEY AUTOINCREMENT, customuser_id bigint NOT NULL REFERENCES authenticator_customuser (id) DEFERRABLE INITIALLY DEFERRED, permission_id integer NOT NULL REFERENCES auth_permission (id) DEFERRABLE INITIALLY DEFERRED) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


CREATE TABLE "administrator_academiccalendar" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "title" varchar(100) NOT NULL, "description" text NOT NULL, "start_date" date NOT NULL, "end_date" date NOT NULL, "event_type" varchar(10) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


CREATE TABLE "administrator_curriculum" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "name" varchar(100) NOT NULL, "description" text NOT NULL, "grade_id" bigint NOT NULL REFERENCES "learners_grade" ("id") DEFERRABLE INITIALLY DEFERRED) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


CREATE TABLE "administrator_curriculum_subjects" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "curriculum_id" bigint NOT NULL REFERENCES "administrator_curriculum" ("id") DEFERRABLE INITIALLY DEFERRED, "subject_id" integer NOT NULL REFERENCES "exams_subject" ("subject_id") DEFERRABLE INITIALLY DEFERRED) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


CREATE TABLE "administrator_teacherassignment" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "grade_id" bigint NOT NULL REFERENCES "learners_grade" ("id") DEFERRABLE INITIALLY DEFERRED, "subject_id" integer NOT NULL REFERENCES "exams_subject" ("subject_id") DEFERRABLE INITIALLY DEFERRED, "teacher_id" bigint NOT NULL REFERENCES "administrator_teacher" ("id") DEFERRABLE INITIALLY DEFERRED) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE "administrator_attendance" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "date" date NOT NULL, "learner_id" bigint NOT NULL REFERENCES "learners_learnerregister" ("id") DEFERRABLE INITIALLY DEFERRED, "status" varchar(10) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


CREATE TABLE "exams_behavioralassessment" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "category" varchar(50) NOT NULL, "rating" varchar(20) NOT NULL, "comment" text NOT NULL, "exam_type_id" integer NOT NULL REFERENCES "exams_examtype" ("exam_id") DEFERRABLE INITIALLY DEFERRED, "learner_id" bigint NOT NULL REFERENCES "learners_learnerregister" ("id") DEFERRABLE INITIALLY DEFERRED) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


CREATE TABLE "exams_extracurricularactivity" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "activity" varchar(100) NOT NULL, "role" varchar(50) NOT NULL, "achievement" text NULL, "exam_type_id" integer NOT NULL REFERENCES "exams_examtype" ("exam_id") DEFERRABLE INITIALLY DEFERRED, "learner_id" bigint NOT NULL REFERENCES "learners_learnerregister" ("id") DEFERRABLE INITIALLY DEFERRED) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


CREATE TABLE "exams_learninggoal" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "goal" text NOT NULL, "status" varchar(20) NOT NULL, "exam_type_id" integer NOT NULL REFERENCES "exams_examtype" ("exam_id") DEFERRABLE INITIALLY DEFERRED, "learner_id" bigint NOT NULL REFERENCES "learners_learnerregister" ("id") DEFERRABLE INITIALLY DEFERRED) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


CREATE TABLE "exams_skillsassessment" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "skill" varchar(50) NOT NULL, "rating" varchar(20) NOT NULL, "exam_type_id" integer NOT NULL REFERENCES "exams_examtype" ("exam_id") DEFERRABLE INITIALLY DEFERRED, "learner_id" bigint NOT NULL REFERENCES "learners_learnerregister" ("id") DEFERRABLE INITIALLY DEFERRED) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


CREATE TABLE "exams_socialemotionaldevelopment" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "category" varchar(50) NOT NULL, "rating" varchar(20) NOT NULL, "comment" text NOT NULL, "exam_type_id" integer NOT NULL REFERENCES "exams_examtype" ("exam_id") DEFERRABLE INITIALLY DEFERRED, "learner_id" bigint NOT NULL REFERENCES "learners_learnerregister" ("id") DEFERRABLE INITIALLY DEFERRED) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


CREATE TABLE "exams_specialachievement" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "achievement" text NOT NULL, "date" date NOT NULL, "exam_type_id" integer NOT NULL REFERENCES "exams_examtype" ("exam_id") DEFERRABLE INITIALLY DEFERRED, "learner_id" bigint NOT NULL REFERENCES "learners_learnerregister" ("id") DEFERRABLE INITIALLY DEFERRED) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


CREATE TABLE "exams_standardizedtestscore" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "test_name" varchar(100) NOT NULL, "score" decimal NOT NULL, "date" date NOT NULL, "exam_type_id" integer NOT NULL REFERENCES "exams_examtype" ("exam_id") DEFERRABLE INITIALLY DEFERRED, "learner_id" bigint NOT NULL REFERENCES "learners_learnerregister" ("id") DEFERRABLE INITIALLY DEFERRED) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


CREATE TABLE "exams_studyhabit" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "category" varchar(50) NOT NULL, "rating" varchar(20) NOT NULL, "comment" text NOT NULL, "exam_type_id" integer NOT NULL REFERENCES "exams_examtype" ("exam_id") DEFERRABLE INITIALLY DEFERRED, "learner_id" bigint NOT NULL REFERENCES "learners_learnerregister" ("id") DEFERRABLE INITIALLY DEFERRED) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


CREATE TABLE "exams_supportservice" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "service_type" varchar(50) NOT NULL, "description" text NOT NULL, "start_date" date NOT NULL, "end_date" date NULL, "exam_type_id" integer NOT NULL REFERENCES "exams_examtype" ("exam_id") DEFERRABLE INITIALLY DEFERRED, "learner_id" bigint NOT NULL REFERENCES "learners_learnerregister" ("id") DEFERRABLE INITIALLY DEFERRED) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


CREATE TABLE "exams_teachercomment" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "comment" text NOT NULL, "exam_type_id" integer NOT NULL REFERENCES "exams_examtype" ("exam_id") DEFERRABLE INITIALLY DEFERRED, "learner_id" bigint NOT NULL REFERENCES "learners_learnerregister" ("id") DEFERRABLE INITIALLY DEFERRED, "subject_id" integer NULL REFERENCES "exams_subject" ("subject_id") DEFERRABLE INITIALLY DEFERRED, "teacher_id" bigint NOT NULL REFERENCES "authenticator_customuser" ("id") DEFERRABLE INITIALLY DEFERRED) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


CREATE TABLE "exams_attendance" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "date" date NOT NULL, "status" varchar(10) NOT NULL, "learner_id" bigint NOT NULL REFERENCES "learners_learnerregister" ("id") DEFERRABLE INITIALLY DEFERRED) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


CREATE TABLE "exams_progressreport" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "generated_date" date NOT NULL, "overall_comment" text NOT NULL, "areas_for_improvement" text NOT NULL, "future_recommendations" text NOT NULL, "principal_signature" bool NOT NULL, "parent_signature" bool NOT NULL, "exam_type_id" integer NOT NULL REFERENCES "exams_examtype" ("exam_id") DEFERRABLE INITIALLY DEFERRED, "learner_id" bigint NOT NULL REFERENCES "learners_learnerregister" ("id") DEFERRABLE INITIALLY DEFERRED) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


CREATE TABLE "administrator_teacher" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "name" varchar(100) NOT NULL, "employee_id" varchar(20) NOT NULL UNIQUE, "date_of_birth" date NOT NULL, "email" varchar(254) NOT NULL, "date_joined" date NOT NULL, "address" text NULL, "is_class_teacher" bool NOT NULL, "phone_number" varchar(15) NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE "administrator_teacher_subjects" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "teacher_id" bigint NOT NULL REFERENCES "administrator_teacher" ("id") DEFERRABLE INITIALLY DEFERRED, "subject_id" integer NOT NULL REFERENCES "exams_subject" ("subject_id") DEFERRABLE INITIALLY DEFERRED) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


CREATE TABLE "learners_classlevel" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "level_name" varchar(100) NOT NULL UNIQUE, "level_description" text NOT NULL, "class_representative_female_id" bigint NULL REFERENCES "learners_learnerregister" ("id") DEFERRABLE INITIALLY DEFERRED, "class_representative_male_id" bigint NULL REFERENCES "learners_learnerregister" ("id") DEFERRABLE INITIALLY DEFERRED, "class_teacher_id" bigint NULL REFERENCES "administrator_teacher" ("id") DEFERRABLE INITIALLY DEFERRED) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


CREATE TABLE "fees_feetype" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "name" varchar(100) NOT NULL, "description" text NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


CREATE TABLE "fees_feerecord" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "amount" decimal NOT NULL, "due_date" date NOT NULL, "paid_amount" decimal NOT NULL, "paid_date" date NULL, "status" varchar(10) NOT NULL, "learner_id" bigint NOT NULL REFERENCES "learners_learnerregister" ("id") DEFERRABLE INITIALLY DEFERRED, "fee_type_id" bigint NOT NULL REFERENCES "fees_feetype" ("id") DEFERRABLE INITIALLY DEFERRED) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
